...
$result = mysql_query("select name, format(price,0) as prices, picture from product where genre_ID = '2'");
...
<?php ?><div id="pagebody">
	...
	<div id="earphone"><h2>　ヘッドホン</h2></div>
		...
		?>
		<tr>
		<td rowspan=2><a href="product.php"><img src=<?php print $row['picture']; ?> Border=0 width=180 height=180 /></a></td>
