...
<body>
	...
	if (! isset ( $_SESSION ['name'] )) {
		?>
		<a href="Sign Up.php"><img id=sign_up
				src="../photo/Button_Sign_Up.gif" alt="Sign Up"></a> <a
				href="Sign In.php"><img id=sign_in src="../photo/Button_Sign_In.gif"
				alt="Sign In"></a>
	<?php
	} else {
		?>
		<a href="Mypage.php"><img id=mypage src="../photo/Button_Mypage.gif"
				alt="My Page"></a> <a href="logout.php"><img id=sign_out
				src="../photo/Button_Sign_out.gif" alt="Sign Out"></a>
	<?php
	}
	?>
		...
		<div id="header">
			<h1>
				<a href="TopPage.php">Audio Yamauchi</a>
			</h1>
		</div>
		...
		<div id="select" align="center">
			<form action="Product.php" method="post">
				...
				</select> <input type="text" name="name" size="100"> <input
		...
		<!-- メインメニュー -->
		<div id="menu">
			<a id="menu01" href="EarPhone.php">イヤホン</a> <a id="menu02"
				href="HeadPhone.php">ヘッドホン</a> <a id="menu03" href="AnyThing.php">その他</a>
		</div>
		...
		<div id="cart">
			...
			￥<?php print $row['price'];?>
					...
					<td width="60" align="center"><select name="units[0]">
  			...
  			<?php
				...
				foreach ( $info as $value ) {
					...
					<Td Align="center" Valign="middle">
					<img src="<?php print $row['picture']; ?>" Align="left" alt="SHE9710"
		...
		<!-- フッタ -->
		<div id="footer">
			<address>Copyright (c) HTMQ All Rights Reserved.</address>
		</div>
